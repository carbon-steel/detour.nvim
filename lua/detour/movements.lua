...
-- The movements module introduces backward-incompatible changes. Users who `require` this module will have the new
-- autocmds that allow for "popup aware" window movements. Those who do not will stay with the previous behavior. This
-- approach allows users to opt-in to the new behavior instead of having the behavior change from under their feet.
