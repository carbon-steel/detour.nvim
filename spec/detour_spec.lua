...
describe("detour", function ()
    ...
    it("react to a coverable window closing", function ()
        ...
        assert.False(util.overlap({util.get_text_area_dimensions(popup)}, {util.get_text_area_dimensions(uncoverable_win)}))
    end)
    ...
    it("create popup over current window", function ()
        ...
        assert.False(util.overlap({util.get_text_area_dimensions(window_a)}, {util.get_text_area_dimensions(popup_b)}))
        assert.True(util.overlap({util.get_text_area_dimensions(window_b)}, {util.get_text_area_dimensions(popup_b)}))
        vim.fn.win_gotoid(window_a)
        detour.Detour()
        local popup_a = vim.api.nvim_get_current_win()
        assert.True(util.overlap({util.get_text_area_dimensions(window_a)}, {util.get_text_area_dimensions(popup_a)}))
        assert.False(util.overlap({util.get_text_area_dimensions(window_b)}, {util.get_text_area_dimensions(popup_a)}))
    end)
